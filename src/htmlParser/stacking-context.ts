...
import { BoundCurves, calculateBorderBoxPath, calculatePaddingBoxPath } from './parse/bound-curves';
import { ClipEffect, EffectTarget, IElementEffect, isClipEffect, OpacityEffect, TransformEffect } from './parse/effects';
import { OVERFLOW } from './css/property-descriptors/overflow';
import { equalPath } from './parse/path';
